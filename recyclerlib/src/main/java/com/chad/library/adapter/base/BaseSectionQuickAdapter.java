...
// */
//public abstract class BaseSectionQuickAdapter<T extends BaseData, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
//
//
...
//
//    @Override
//    protected K onCreateViewHolderByType(ViewGroup parent, int viewType) {
//        if (viewType == SECTION_HEADER_VIEW)
//            return createBaseViewHolder(getItemView(mSectionHeadResId, parent));
//
//        return super.onCreateViewHolderByType(parent, viewType);
//    }
//
//    @Override
