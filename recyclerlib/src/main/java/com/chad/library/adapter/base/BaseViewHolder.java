 ...
 */
public class BaseViewHolder<T extends BaseData> extends RecyclerView.ViewHolder {
    ...
    protected void initWidgets(View itemView) {
    ...
    @CallSuper
    public void setData(T data, int dataPosition) {
        setData(data);
    }
    ...
    public int getColor(int id) {
        return itemView.getResources().getColor(id);
    }

    public ColorStateList getColorStateList(int id) {
        return itemView.getResources().getColorStateList(id);
    }

    public Drawable getDrawable(int id) {
        return itemView.getResources().getDrawable(id);
    }
