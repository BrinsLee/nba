...
import static com.chad.library.adapter.base.BaseQuickAdapter.STATE_VIEW;
...
//                mPressedView.setPressed(true);
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        /**
         *  have a headview and STATE_VIEW FOOTER_VIEW LOADING_VIEW
         */
        ...
        return (type == STATE_VIEW || type == HEADER_VIEW || type == FOOTER_VIEW || type == LOADING_VIEW);
    }
